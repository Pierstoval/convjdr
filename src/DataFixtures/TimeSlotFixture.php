    ...
    protected function getObjects(): iterable
    {
        return [
            [
                ...
                'endsAt' => (new \DateTimeImmutable('today'))->setTime(2, 0, 0, 0),
            ...
            [
                ...
                'endsAt' => (new \DateTimeImmutable('today'))->setTime(3, 0, 0, 0),
                'table' => $this->getReference('table-Table face pôle JdR 1'),
                'event' => $this->getReference('event-TDC 2025'),
                'category' => $this->getReference('time-slot-category-Morning'),
            ],
            [
                ...
                'endsAt' => (new \DateTimeImmutable('today'))->setTime(4, 0, 0, 0),
                'table' => $this->getReference('table-Table face pôle JdR 1'),
                'event' => $this->getReference('event-TDC 2025'),
                'category' => $this->getReference('time-slot-category-Morning'),
            ],
            [
                ...
                'endsAt' => (new \DateTimeImmutable('today'))->setTime(5, 0, 0, 0),
                'table' => $this->getReference('table-Table face pôle JdR 1'),
                'event' => $this->getReference('event-TDC 2025'),
                'category' => $this->getReference('time-slot-category-Morning'),
            ],
